...
# Example usage: qsub -cwd -pe smp 4 -l mem_free=16G -l h_rt=120:00:00 classifier/check_database_distribution.sh

conda activate pyuoi
python classifier/check_database_distributions.py
conda deactivate
