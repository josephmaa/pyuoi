...
# Example usage: qsub -cwd -pe smp 4 -l mem_free=16G -l h_rt=120:00:00 downsample_multiple_databases.sh test.db

conda activate pyuoi
python downsample_multiple_databases.py --database_path $1
conda deactivate
